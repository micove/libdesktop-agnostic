/* test-vfs-volume.c generated by valac, the Vala compiler
...
TestVolume* test_volume_construct (GType object_type) {
	TestVolume* self;
	self = (TestVolume*) g_type_create_instance (object_type);
	return self;
}
...
GType test_volume_get_type (void) {
	static GType test_volume_type_id = 0;
	if (test_volume_type_id == 0) {
