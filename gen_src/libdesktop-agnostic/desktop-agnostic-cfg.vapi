/* desktop-agnostic-cfg.vapi generated by valac, do not modify. */
...
namespace DesktopAgnostic {
	...
	namespace Config {
		...
		public abstract class Backend : GLib.Object {
			...
			public abstract void notify (string group, string key) throws GLib.Error;
		...
		public class Client : GLib.Object {
			...
			public void notify (string group, string key) throws GLib.Error;
