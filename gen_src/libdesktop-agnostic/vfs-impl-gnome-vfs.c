/* vfs-impl-gnome-vfs.c generated by valac 0.10.4, the Vala compiler
...
GType desktop_agnostic_vfs_gnome_vfs_implementation_get_type (void) G_GNUC_CONST;
...
DesktopAgnosticVFSGnomeVFSImplementation* desktop_agnostic_vfs_gnome_vfs_implementation_construct (GType object_type) {
	DesktopAgnosticVFSGnomeVFSImplementation * self = NULL;
...
GType desktop_agnostic_vfs_gnome_vfs_implementation_get_type (void) {
	static volatile gsize desktop_agnostic_vfs_gnome_vfs_implementation_type_id__volatile = 0;
	if (g_once_init_enter (&desktop_agnostic_vfs_gnome_vfs_implementation_type_id__volatile)) {
		...
		GType desktop_agnostic_vfs_gnome_vfs_implementation_type_id;
		...
		g_once_init_leave (&desktop_agnostic_vfs_gnome_vfs_implementation_type_id__volatile, desktop_agnostic_vfs_gnome_vfs_implementation_type_id);
	}
