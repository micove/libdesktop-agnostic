/* vfs-file-monitor-impl-gnome-vfs.c generated by valac, the Vala compiler
...
GType desktop_agnostic_vfs_file_monitor_gnome_vfs_get_type (void) {
	static GType desktop_agnostic_vfs_file_monitor_gnome_vfs_type_id = 0;
	if (desktop_agnostic_vfs_file_monitor_gnome_vfs_type_id == 0) {
	...
	return desktop_agnostic_vfs_file_monitor_gnome_vfs_type_id;
}
