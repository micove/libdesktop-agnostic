/* desktop-entry.c generated by valac, the Vala compiler
...
GType desktop_agnostic_fdo_desktop_entry_launch_flags_get_type (void) {
	static GType desktop_agnostic_fdo_desktop_entry_launch_flags_type_id = 0;
	if (G_UNLIKELY (desktop_agnostic_fdo_desktop_entry_launch_flags_type_id == 0)) {
	...
	return desktop_agnostic_fdo_desktop_entry_launch_flags_type_id;
}



GType desktop_agnostic_fdo_desktop_entry_type_get_type (void) {
	static GType desktop_agnostic_fdo_desktop_entry_type_type_id = 0;
	if (G_UNLIKELY (desktop_agnostic_fdo_desktop_entry_type_type_id == 0)) {
	...
	return desktop_agnostic_fdo_desktop_entry_type_type_id;
}
...
GType desktop_agnostic_fdo_desktop_entry_get_type (void) {
	static GType desktop_agnostic_fdo_desktop_entry_type_id = 0;
	if (desktop_agnostic_fdo_desktop_entry_type_id == 0) {
	...
	return desktop_agnostic_fdo_desktop_entry_type_id;
}
...
DesktopAgnosticFDODesktopEntry* desktop_agnostic_fdo_desktop_entry_new (GError** error) {
	DesktopAgnosticFDODesktopEntry* result;
	GError * _inner_error_;
	GType type;
	_inner_error_ = NULL;
	...
	if (type == G_TYPE_INVALID) {
		...
		result = DESKTOP_AGNOSTIC_FDO_DESKTOP_ENTRY (g_object_new (type, NULL));
		return result;
	}
}
...
DesktopAgnosticFDODesktopEntry* desktop_agnostic_fdo_desktop_entry_new_for_file (DesktopAgnosticVFSFile* file, GError** error) {
	...
	if (type == G_TYPE_INVALID) {
		...
		result = DESKTOP_AGNOSTIC_FDO_DESKTOP_ENTRY (g_object_new (type, "file", file, NULL));
		return result;
	}
}
...
DesktopAgnosticFDODesktopEntry* desktop_agnostic_fdo_desktop_entry_new_for_keyfile (GKeyFile* keyfile, GError** error) {
	...
	if (type == G_TYPE_INVALID) {
		...
		result = DESKTOP_AGNOSTIC_FDO_DESKTOP_ENTRY (g_object_new (type, "keyfile", keyfile, NULL));
		return result;
	}
}
...
DesktopAgnosticFDODesktopEntry* desktop_agnostic_fdo_desktop_entry_new_for_data (const char* data, GError** error) {
	...
	if (type == G_TYPE_INVALID) {
		...
		result = DESKTOP_AGNOSTIC_FDO_DESKTOP_ENTRY (g_object_new (type, "data", data, NULL));
		return result;
	}
}
