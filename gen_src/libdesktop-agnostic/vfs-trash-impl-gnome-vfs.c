/* vfs-trash-impl-gnome-vfs.c generated by valac, the Vala compiler
...
GType desktop_agnostic_vfs_trash_volume_get_type (void) {
	static GType desktop_agnostic_vfs_trash_volume_type_id = 0;
	if (desktop_agnostic_vfs_trash_volume_type_id == 0) {
	...
	return desktop_agnostic_vfs_trash_volume_type_id;
}
...
static gboolean _desktop_agnostic_vfs_trash_gnome_vfs_search_for_trash_dirs_gsource_func (gpointer self) {
	return desktop_agnostic_vfs_trash_gnome_vfs_search_for_trash_dirs (self);
}
...
static GObject * desktop_agnostic_vfs_trash_gnome_vfs_constructor (GType type, guint n_construct_properties, GObjectConstructParam * construct_properties) {
	...
	self = DESKTOP_AGNOSTIC_VFS_TRASH_GNOME_VFS (obj);
	{
		...
		self->trash_dirs = (_tmp0_ = g_hash_table_new (g_direct_hash, g_direct_equal), _g_hash_table_unref0 (self->trash_dirs), _tmp0_);
...
GType desktop_agnostic_vfs_trash_gnome_vfs_get_type (void) {
	static GType desktop_agnostic_vfs_trash_gnome_vfs_type_id = 0;
	if (desktop_agnostic_vfs_trash_gnome_vfs_type_id == 0) {
	...
	return desktop_agnostic_vfs_trash_gnome_vfs_type_id;
}
